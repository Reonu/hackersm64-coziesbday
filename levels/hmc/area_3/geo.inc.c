...
const GeoLayout hmc_area_3_geo[] = {
	...
	GEO_OPEN_NODE(),
		...
		GEO_OPEN_NODE(),
			GEO_BRANCH(1, hmc_dl_Cube_001_geo),
		GEO_CLOSE_NODE(),
		GEO_TRANSLATE_NODE_WITH_DL(LAYER_OPAQUE, 0, 500, 0, hmc_dl_Cube_mesh_layer_1),
	GEO_CLOSE_NODE(),
	GEO_RETURN(),
};
const GeoLayout hmc_dl_Cube_001_geo[] = {
	GEO_NODE_START(),
	GEO_OPEN_NODE(),
		GEO_TRANSLATE_NODE_WITH_DL(LAYER_OPAQUE, -1072, -1213, -595, hmc_dl_Cube_001_mesh_layer_1),
	GEO_CLOSE_NODE(),
	GEO_RETURN(),
};
