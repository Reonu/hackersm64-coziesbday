...
const LevelScript level_hmc_entry[] = {
	...
	AREA(1, hmc_area_1),
		...
		OBJECT(MODEL_PUZZLE_GREEN, -414, 278, 852, 0, 0, 0, (0x00 << 24) | (0x01 << 16) | (0x00 << 8) | (0x00), bhvPuzzlePiece),
		OBJECT(MODEL_PUZZLE_RED, -241, 105, 852, 0, 0, 0, (0x00 << 24) | (0x02 << 16) | (0x00 << 8) | (0x00), bhvPuzzlePiece),
		OBJECT(MODEL_PUZZLE_YELLOW, -241, 278, 852, 0, 0, 0, (0x00 << 24) | (0x00 << 16) | (0x00 << 8) | (0x00), bhvPuzzlePiece),
		OBJECT(MODEL_PUZZLE_RED, 116, 278, 852, 0, 0, 0, (0x00 << 24) | (0x02 << 16) | (0x00 << 8) | (0x00), bhvStar),
		OBJECT(MODEL_PUZZLE_BLUE, -414, 105, 852, 0, 0, 0, (0x00 << 24) | (0x03 << 16) | (0x00 << 8) | (0x00), bhvPuzzlePiece),
		OBJECT(MODEL_PUZZLE_BLUE, -1, 278, 852, 0, 0, 0, (0x00 << 24) | (0x03 << 16) | (0x00 << 8) | (0x00), bhvStar),
		OBJECT(MODEL_NONE, 9039, 1290, 9667, 0, 0, 0, (0x00 << 24) | (0x08 << 16) | (0x00 << 8) | (0x00), bhvLllRotatingHexagonalRing),
		OBJECT(MODEL_PUZZLE_YELLOW, 481, 278, 852, 0, 0, 0, (0x00 << 24) | (0x00 << 16) | (0x00 << 8) | (0x00), bhvStar),
		OBJECT(MODEL_PUZZLE_GREEN, 279, 278, 852, 0, 0, 0, (0x00 << 24) | (0x01 << 16) | (0x00 << 8) | (0x00), bhvStar),
