...
const LevelScript level_hmc_entry[] = {
	...
	AREA(1, hmc_area_1),
		...
		OBJECT(MODEL_PUZZLE_YELLOW, -241, 278, 852, 0, 0, 0, (0x00 << 24) | (0x08 << 16) | (0x00 << 8) | (0x00), bhvStaticObject),
		OBJECT(MODEL_PUZZLE_GREEN, -414, 278, 852, 0, 0, 0, (0x00 << 24) | (0x08 << 16) | (0x00 << 8) | (0x00), bhvStaticObject),
		OBJECT(MODEL_PUZZLE_BLUE, -414, 105, 852, 0, 0, 0, (0x00 << 24) | (0x08 << 16) | (0x00 << 8) | (0x00), bhvStaticObject),
		OBJECT(MODEL_PUZZLE_RED, -241, 105, 852, 0, 0, 0, (0x00 << 24) | (0x08 << 16) | (0x00 << 8) | (0x00), bhvStaticObject),
