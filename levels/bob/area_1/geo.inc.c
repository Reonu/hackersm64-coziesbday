...
const GeoLayout bob_area_1_geo[] = {
	GEO_NODE_START(),
	GEO_OPEN_NODE(),
		GEO_DISPLAY_LIST(LAYER_OPAQUE, bob_dl_Airplane_002_mesh_layer_1),
		GEO_TRANSLATE_NODE(LAYER_OPAQUE, 0, -58, 0),
		GEO_TRANSLATE_NODE(LAYER_OPAQUE, 0, -58, 0),
		GEO_TRANSLATE_NODE(LAYER_OPAQUE, 0, -58, 0),
		GEO_TRANSLATE_NODE(LAYER_OPAQUE, 0, -58, 0),
		GEO_TRANSLATE_NODE(LAYER_OPAQUE, 0, -58, 0),
		GEO_TRANSLATE_NODE(LAYER_OPAQUE, 0, -58, 0),
		GEO_TRANSLATE_NODE(LAYER_OPAQUE, 0, -58, 0),
		GEO_TRANSLATE_NODE_WITH_DL(LAYER_TRANSPARENT, 28, -2811, -37, bob_dl_Plane_mesh_layer_5),
	GEO_CLOSE_NODE(),
	GEO_RETURN(),
};
